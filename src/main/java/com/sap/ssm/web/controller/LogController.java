...
public class LogController {
    ...
    /**
     * The API to create a new Log<br> <br> API URL - <b>"/api/log"</b><br>
     * Method - <b>"POST"</b>
     * @param logMergeRequest the request body for creating a new log
    ...
    /**
     * The API for delete a log by its id<br> <br> API URL -
     * <b>"/api/session/{id}"</b> <br> Method - <b>"DELETE"</b>
     * @param id session id
    ...
    /**
     * The API for find logs by several optional parameters<br> <br> API URL -
     * <b>"/api/session"</b><br> Method - <b>"GET"</b>
     * @param userId Optional log userId The userId of the log
     * @param date1 Optional log date1 The beginning date
     * @param date2 Optional log date2 The ending date
